...
<html lang="en">
	<head>
		...
		<link href="<?php echo base_url('assets/gogroup/css/styles.css');?>" rel="stylesheet">
...
<div id="aboutModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
	...
	<!-- script references -->
		...
		<script src="<?php echo base_url('assets/gogroup/js/bootstrap.min.js');?>"></script>
		<script src="<?php echo base_url('assets/gogroup/js/scripts.js');?>"></script>
	</body>
</html>