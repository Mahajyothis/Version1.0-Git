...
<div class="row">
        ...
        <div class="input-group">
            <input type="text" class="form-control search-query" name="search" value="<?php echo $_GET['search'];?>" id="search" placeholder="<?php echo $lang['search-discussion'];?>.." / style="width: 300px"> <span class="input-group-btn">
