...
<div class="col-sm-12">
    ...
    <div class="col-sm-2">
        ...
        <div class="input-group">
            <input type="text" class="form-control search-query" name="search" value="<?php echo $_GET['search'];?>" id="search" placeholder="<?php echo $lang['search_question']; ?>..." /> <span class="input-group-btn">
...
?>
<a href="#deleteComment" data-toggle="modal" data-q="<?php echo $result->id_que;?>" data-comment="<?php //echo $row['uaID'];?>"  data-target="#deleteComment" class="deleteComment"><img src="<?php //echo base_url('assets/forum_n/images/delete.png');?>" width="8" height="8" alt="">
<?php 
}
?>
</div>
		...
		WHERE ua.`uaCategory`='FORUM' AND ua.`catID`=".$result->id_que." ORDER BY ua.`uaID` DESC LIMIT 5");
                    ...
                    {
                        ?>
                        <a href="javascript:void(0)" class="view_more_forum_comments old_comments" style="color: darkgreen; font-weight: bold" data-postid="<?php echo $result->id_que;?>">view more comments</a>
                    <?php
                    }
                    ?>
                    <span class="user<?php echo $result->id_que; ?>" id="<?php echo $result->custID; ?>">
                   <a href="javascript:void(0)" class="view_more_forum_comments new_comments" data-postid="<?php echo $result->id_que;?>" style="color: darkgreen; font-weight: bold;display: none">view more comments</a>
                    ...
                    <input type="text" class="form-control" id="user_comment<?php echo $result->id_que; ?>" placeholder="<?php echo $lang['write_something_here']; ?>............." style="width:25%"><button style="float:left;margin-top:1%;margin-bottom:1%" class="btn btn-warning comment"  id="<?php echo $result->id_que;?>"><?php echo $lang['comment']; ?></button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0)" class="ForDeleteComment" style="text-decoration: none;" id="" data-id="">
                    <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" id="deleteCommentBtn"><?php echo $lang['yes']; ?></button>
                </a>
                <button type="button" class="btn btn-success btn-sm" data-dismiss="modal"><?php echo $lang['no']; ?></button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0)" class="for_comment_id" style="text-decoration: none;" id="">
                    ...
                    <button type="button" class="btn btn-danger btn-sm" id="editCommentBtn"><?php echo $lang['update'];?></button>
                </a>
                <button type="button" class="btn btn-success btn-sm" id="cancelAtEditComment" data-dismiss="modal"><?php echo $lang['cancel'];?></button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0)" style="text-decoration: none;" id="">
                    <button type="button" class="btn btn-danger btn-sm" id="deleteConfirmBtn"><?php echo $lang['confirm'];?></button>
                </a>
                <button type="button" class="btn btn-success btn-sm" data-dismiss="modal"><?php echo $lang['cancel'];?></button>
            </div>
        </div>
    </div>
</div>
...
<div style=" padding-top:5px;" align="left"><font style="font-family:Verdana, Geneva, sans-serif; font-size:11px;">Can't read? <span class="ccc"><a href="javascript:void(0);" onClick="vpb_refresh_aptcha();" id="refCaptcha">Refresh</a></span></font></div>
...
<?php echo $this->session->userdata['profile_data'][0]['perdataFirstName']." ".$this->session->userdata['profile_data'][0]['perdataLastName'];?>
			...
			<div class="col-sm-10">
				...
				<span  id="user_like" >
				<button class="pst-lke btn btn-info like btn-xs"><span id="">0</span> <i class="fa fa-thumbs-o-up" style="padding-right:5px;"></i>like </button>
				</span>
				...
				<a href="javascript:void(0)" class="new_comments1"  style="color: darkgreen; font-weight: bold;display: none">view more comments</a>
				<!----------------------------------------------------------------------------------------------------------->
				<input type="text" class="form-control user_comment"  placeholder="<?php echo $lang['write_something_here'];?>............."><button style="float:left;margin-top:1%;margin-bottom:1%" class="btn btn-warning comment" ><?php echo $lang['comment'];?></button>
				<p>
				</p>
				<br>
				</span>
                            ...
                            <div class="modal-dialog" role="document" style="z-index:9999;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="#" style="cursor:pointer;text-decoration: none;" class="" id="idtoHide"><button type="button" class="btn btn-danger btn-sm" id="preHidethis"><?php echo $lang['hide'];?></button></a>
                                        <button type="button" class="btn btn-success btn-sm" data-dismiss="modal"><?php echo $lang['cancel'];?></button>
                                    </div>
                                    </form>
                                </div>
