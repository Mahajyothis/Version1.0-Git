        ...
        <div class="tilecontent">
                    ...
                    <div class="joind-clsss">
                        ...
                        else if($countData != 0 && $statusUser->gistatus == 3)
                        {
                            ...
                            <p class="slct-bck-clr" style="text-align:center;padding-top:5px;" id="<?php echo $statusUser->giID; ?>">
                                ...
                                <i class="fa fa-exclamation-circle"></i> <?= $lang['pending'];?><small>|</small> <a href="#" class='LeaveGroup'><?= $lang['cancel'];?></a>
            ...
            <div class="col-md-12 group_section" style="background-color:#081c1a;padding-top:10px;padding-bottom:-2px;margin-top: -3px;">
                ...
                <div class="col-md-4 "><i class="fa fa-user "></i>
                    <p style="padding-left:19px;margin-top: -14px;color: #40a293;"><?= $lang['admin'];?> <span style="font-style:italic;"><?php echo ucwords($results->custName); ?></span> </p>
                </div>
                    ...
                    <div id="add-pst-vide">
                        <form class="form-horizontal" id="imageUploadwithStaus" method="post" enctype="multipart/form-data" action="<?php echo base_url().'groups/doPostwithImage/'.$r;?>" role="form">
                            ...
                            <div class="row-fluid">
                                ...
                                <textarea class="commnt-txtara" name="postTextinImage" id="postTextinImage" required placeholder="<?= $lang['what_you_want_to_say'];?>..!" style="width: 92%;margin-left:5px;height: 49px;"></textarea>
                            </div>
    ...
    {?>
        ...
        <div class="row" style="margin:0 auto">
            ...
            <div class="col-md-12 " style="background: rgba(8, 28, 26, 0.92) none repeat scroll 0% 0%;margin: 0px auto;">
                <div class="lke-cmnt" style="padding: 8px;margin-bottom: 0px;">
...
margin: 0px;">
                                ...
                                <span style='padding-left: 2%;color: rgb(234, 222, 222);'><span id="singlcomment_<?php echo $row['uaID'];?>"><?php echo $row['comment']; ?></span></span>
                                ...
                                if($this->session->userdata['profile_data'][0]['custID'] == $row['custID'])
                                {
                                    ...
                                    <a class="deleteComment"  data-comment="<?php echo $row['uaID'];?>" href="javascript:void(0)" data-toggle="modal" data-p="<?php echo $post->id;?>"  data-target="#deleteComment" ><span class="icn-spce-grp"><i class="fa fa-trash-o" style="color:darkred"></i></span></a>
        ...
        if($total_recent_count > 4)
        {
            ...
            ?>
            <a href="javascript:void(0)" class="view_more_com" id="view_more_com<?php echo $post->id;?>" style="color: #359587; font-weight: bold" data-postid="<?php echo $post->id;?>"><?= $lang['view_more_comments'];?></a>
            <div id="loading_img<?php echo $post->id;?>"></div>
        ...
        <a href="javascript:void(0)" class="view_more_com" id="view_more<?php echo $post->id;?>" data-postid="<?php echo $post->id;?>" style="color: #359587; font-weight: bold; display:none"><?= $lang['view_more_comments'];?></a>
        <div id="loading_img<?php echo $post->id;?>"></div>
        <!---------------Rohitdutta------------------------------------------------------------------------------------------------------->
        </div>
...
<div class="overlay" id="editStatusWithPhoto">
    <div class="modal1" style="width: 28%;height:55%;padding: 1%;box-shadow: 0px 4px 15px 2px rgba(19, 21, 24, 0.4);">
        ...
        <h3 class="block-title" style="margin-top: -7px;margin-left: 9px;margin-bottom: 19px;"><?= $lang['edit_status_with_photo'];?></h3>
...
<div class="overlay" id="editEventSection">
    <div class="modal1" style="width: 30%;height:55%;padding: 1%;box-shadow: 0px 4px 15px 2px rgba(19, 21, 24, 0.4);">
        ...
        <h3 class="block-title" style="margin-top: 15px;
margin-left: 9px;"><?= $lang['edit_event'];?></h3>
        <form id="contactme" class="form-dark" name="cform" method="post" action="">
            ...
            <div class="row-fluid"  >
                ...
                <input type="text" class="span12" id="eventLocationEdit" name="eventLocationEdit" placeholder="<?= $lang['location'];?>" />
            </div>

            <div class="row-fluid"  >
                <label><?= $lang['event_date'];?></label>

                <input type="text" class="span12 eventDate" id="eventDateEdit" name="eventDateEdit" placeholder="Event date" placeholder="<?= $lang['event_date'];?>" />
            </div>


            <div class="row-fluid"  >
                <label><?= $lang['event_description'];?></label>
                <textarea class="span12" name="eventDesEdit" id="eventDesEdit" placeholder="<?= $lang['event_description'];?>..."></textarea>
            </div>
...
<div id="new_hidden" class="hide">
    ...
    <div class="pst-cntnts new_post" style="height:100%;background-color: #0c231d; margin-bottom: 22px;" id="">
        ...
        <div class="com" id="comments3" style="margin-top: 0px;">
            ...
            <input type="text" class="get_post_id" value="" style="display:none">



            <input type="text"  id="display_total_recent_comments" value="0" style="display:none">


            <a href="javascript:void(0)" class="view_more_com" id="" data-postid=""  style="color: #359587; font-weight: bold;display: none"><?= $lang['view_more_comments'];?></a>
            <div class="loading_img" id="loading_img"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0)" class="ForDeleteComment" style="text-decoration: none;" id="" data-postid="">
                    <button type="button" class="btn btn-success btn-xs" id="del" data-dismiss="modal"><?= $lang['confirm'];?></button>
                </a>
                <button type="button" class="btn btn-danger btn-xs" id="cancelAtDeleteComment" data-dismiss="modal"><?= $lang['cancel'];?></button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" style="color: darkgreen; font-weight: bold"><?= $lang['edit_comment'];?></h3>
            </div>
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" id="edit_s_c">
                    <input type="text" class="ForEditComment" name="edit_single_comment" id="edit_single_comment" value=""/>

                </form>
            </div>
            <div class="modal-footer">
                <a href="javascript:void(0)" class="for_comment_id"  id="">

                    <button type="button" class="btn btn-success btn-sm" id="editCommentBtn"><?= $lang['update'];?></button>
                </a>
                <button type="button" class="btn btn-danger btn-sm" id="cancelAtEditComment" data-dismiss="modal"><?= $lang['cancel'];?></button>
            </div>
        </div>
    </div>
</div>
