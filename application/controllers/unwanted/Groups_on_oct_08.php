...
class Groups extends CI_Controller{
	...
	//echo $this->input->post('postApostContent');
	//echo $this->session->userdata['groupID'];exit;
...
<div class='coment_display' style='padding: 3%;background-color:rgba(24, 64, 53, 0.69);height: 45px;' ><p>";
			
			if(ISSET($all->photo)){
				echo "<img src='/uploads/".$all->photo."' style='width: 30px;height: 30px;float: left;border-radius: 50px;'>";
			}
			else{
				echo "<img src='/uploads/profile.png' style='width: 30px;height: 30px;float: left;border-radius: 50px;'>";
			}
						
	echo "<b style='margin-left:12%'>".$all->uaDescription."</b></div>";
        }
