...
<div class='coment_display' style='margin:5%' ><p>";
			
			if(ISSET($all->photo)){
				echo "<img src='/uploads/".$all->photo."' style='width:30px;float:left'>";
			}
			else{
				echo "<img src='/uploads/profile.png' style='width:30px;float:left'>";
			}
...
echo "<div class='cmnt-area-bottm' style='height: 49px; background: #120A0A;'>
