...
$(document).ready(function(){
  $(document).on('click','span.unlike',function(){
               ...
               var pid=$(".user"+catid).attr('id');
                    ...
                    $("#user_unlike"+catid).html('<span id="user_like'+catid+'"><span class="small" style="padding:3px;border-radius:3px;" ><span class="small fa fa-thumbs-up like" id="'+catid+'" style="color:white;"> <?= $lang["like"];?></span></span></span>').fadeIn('slow');
